...
![Splunk Bots v1-9.png](/img/user/x/images/Splunk%20Bots%20v1-9.png)
...
**Sourcetypes:**
![Splunk Bots v1-10.png](/img/user/x/images/Splunk%20Bots%20v1-10.png)
...
![Splunk Bots v1-11.png](/img/user/x/images/Splunk%20Bots%20v1-11.png)
...
**Output:** 
![Splunk Bots v1-12.png](/img/user/x/images/Splunk%20Bots%20v1-12.png)
Viewing one of the events:
![Splunk Bots v1-13.png](/img/user/x/images/Splunk%20Bots%20v1-13.png)
...
**Output:** 
![Splunk Bots v1-14.png](/img/user/x/images/Splunk%20Bots%20v1-14.png)
...
![Splunk Bots v1-15.png](/img/user/x/images/Splunk%20Bots%20v1-15.png)
Then viewing the src, the same culprit appears and is responsible for 97% of the request:

![Splunk Bots v1-16.png](/img/user/x/images/Splunk%20Bots%20v1-16.png)
...
![Splunk Bots v1-17.png](/img/user/x/images/Splunk%20Bots%20v1-17.png)
...
![Splunk Bots v1-18.png](/img/user/x/images/Splunk%20Bots%20v1-18.png)
Then the first brute-forced password is: (12345678)

![Splunk Bots v1-19.png](/img/user/x/images/Splunk%20Bots%20v1-19.png)
...
Output:
![Splunk Bots v1-20.png](/img/user/x/images/Splunk%20Bots%20v1-20.png)
...
![Splunk Bots v1-21.png](/img/user/x/images/Splunk%20Bots%20v1-21.png)
or a regex of:
...
![Splunk Bots v1-22.png](/img/user/x/images/Splunk%20Bots%20v1-22.png)
...
![Splunk Bots v1-23.png](/img/user/x/images/Splunk%20Bots%20v1-23.png)
We can go further down and be specific by adding `http_method == 'POST'` then viewing the filename sidebar: 

![Splunk Bots v1-24.png](/img/user/x/images/Splunk%20Bots%20v1-24.png)
...
![Splunk Bots v1-25.png](/img/user/x/images/Splunk%20Bots%20v1-25.png)
**Viewing with fgt_utm as source**:

![Splunk Bots v1-26.png](/img/user/x/images/Splunk%20Bots%20v1-26.png)
...
Output:
![Splunk Bots v1-27.png](/img/user/x/images/Splunk%20Bots%20v1-27.png)
...
![Splunk Bots v1-28.png](/img/user/x/images/Splunk%20Bots%20v1-28.png)
...
Output:
![Splunk Bots v1-30.png](/img/user/x/images/Splunk%20Bots%20v1-30.png)
