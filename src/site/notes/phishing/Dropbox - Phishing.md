---
{"dg-publish":true,"permalink":"/phishing/dropbox-phishing/","tags":["phishing"]}
---
...
![SOC 101 - Phishing Challenge 2.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202.png)
...
![SOC 101 - Phishing Challenge 2-1.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-1.png)
Looking up the domain found on `return-path` header using [whois.domaintools.com](whois.domaintools.com) matches with dropbox:

![SOC 101 - Phishing Challenge 2-2.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-2.png)
...
![SOC 101 - Phishing Challenge 2-3.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-3.png)
### Authenticating Email
---
Both DKIM and SPF passed:

![SOC 101 - Phishing Challenge 2-4.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-4.png)
```
dig TXT email.dropbox.com | grep -i "spf"
```

Output:
![SOC 101 - Phishing Challenge 2-5.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-5.png)
Looking up the SPF record of amazonses.com and comparing with the IP address found on a `received` header:

![SOC 101 - Phishing Challenge 2-6.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-6.png)
Command:
...
![SOC 101 - Phishing Challenge 2-7.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-7.png)
Additionally this is the resolved address of 54.240.60.143:

![SOC 101 - Phishing Challenge 2-13.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-13.png)
## Content Analysis
---
...
![SOC 101 - Phishing Challenge 2-8.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-8.png)
But using VirusTotal against the same link, one of the security vendors flagged it as malicious:

![SOC 101 - Phishing Challenge 2-9.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-9.png)
...
![SOC 101 - Phishing Challenge 2-10.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-10.png)
Second Link:
...
![SOC 101 - Phishing Challenge 2-11.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-11.png)
urlscan.io:

![SOC 101 - Phishing Challenge 2-12.png](/img/user/phishing/images/SOC%20101%20-%20Phishing%20Challenge%202-12.png)
