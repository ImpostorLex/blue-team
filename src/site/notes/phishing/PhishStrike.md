...
![PhishStrike.png](/img/user/phishing/images/PhishStrike.png)
...
![PhishStrike-1.png|450](/img/user/phishing/images/PhishStrike-1.png)
...
![PhishStrike-2.png](/img/user/phishing/images/PhishStrike-2.png)
...
![PhishStrike-3.png](/img/user/phishing/images/PhishStrike-3.png)
Then inputting it to:

[mxtoolbox.com](https://mxtoolbox.com/SuperTool.aspx?action=dkim%3auptc.edu.co%3agoogle&run=toolpage)

![PhishStrike-4.png](/img/user/phishing/images/PhishStrike-4.png)
...
![PhishStrike-5.png](/img/user/phishing/images/PhishStrike-5.png)
At the **Authentication Results** header says otherwise:

![PhishStrike-6.png](/img/user/phishing/images/PhishStrike-6.png)
...
![PhishStrike-7.png|450](/img/user/phishing/images/PhishStrike-7.png)
Definetly a suspicious email.

Also performing a lookup on the **Sender IP address** found on the image above ( 18.208.22.104):

![PhishStrike-10.png|450](/img/user/phishing/images/PhishStrike-10.png)
...
![PhishStrike-8.png](/img/user/phishing/images/PhishStrike-8.png)
Using tools such as `urlscan.io` to view the website results into unavailable as most likely the website is taken down:

![PhishStrike-9.png](/img/user/phishing/images/PhishStrike-9.png)
**Submitting the URL to urlhaus**

![PhishStrike-11.png](/img/user/phishing/images/PhishStrike-11.png)
Then clicking the `Bazaar's Coinminer` icon to determine it's behavior:

![PhishStrike-12.png](/img/user/phishing/images/PhishStrike-12.png)
Selecting `anyrun.io` shows contacted IP addresses:

![PhishStrike-13.png](/img/user/phishing/images/PhishStrike-13.png)
